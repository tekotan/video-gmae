...
# callbacks.model_checkpoint.every_n_epochs=1 \
# configs.training_type="eval-kinetics_ucf101_point-tracking_save-images_no-mask_random-frames" \
# configs.load_strict=False \
# configs.mask_ratio=0.0 \
...
# model._target_="chewbacca.models.finetune.FinetuneLitModule" \
# datamodule._target_="chewbacca.datamodules.finetune_datamodule.FinetuneDataModule" \
# task_name=vit_large_mae_st_finetune_point_tracking_crossattn_v1 \
# trainer=ddp_unused \
# trainer.devices=1 \
# trainer.num_nodes=1 \
# configs.task="finetune" \
...
# model._target_="chewbacca.models.finetune.FinetuneLitModule" \
# datamodule._target_="chewbacca.datamodules.finetune_datamodule.FinetuneDataModule" \
# task_name=vit_base_videomae_fullfinetune_point_tracking_crossattn_v1 \
# trainer=ddp_unused \
# trainer.devices=1 \
# trainer.num_nodes=1 \
# configs.task="finetune" \
...
# model._target_="chewbacca.models.finetune.FinetuneLitModule" \
# datamodule._target_="chewbacca.datamodules.finetune_datamodule.FinetuneDataModule" \
# task_name=vit_base_videomae_finetune_point_tracking_crossattn_v1 \
# trainer=ddp_unused \
# trainer.devices=1 \
# trainer.num_nodes=1 \
# configs.task="finetune" \
...
# model._target_="chewbacca.models.finetune.FinetuneLitModule" \
# datamodule._target_="chewbacca.datamodules.finetune_datamodule.FinetuneDataModule" \
# task_name=vit_large_videomae_fullfinetune_point_tracking_crossattn_v2 \
# trainer=ddp_unused \
# trainer.devices=1 \
# trainer.num_nodes=1 \
# configs.task="finetune" \
...
# trainer.limit_val_batches=100 \
# callbacks.model_checkpoint.every_n_epochs=1 \
# configs.training_type="eval-rgb_ucf101_point-tracking_save-images_no-mask_random-frames" \
# configs.load_strict=False \
# configs.mask_ratio=0.0 \
# configs.finetune_params.reuse_decoder=False \
# configs.finetune_params.num_fourier_features=64 \
