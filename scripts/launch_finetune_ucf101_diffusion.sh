...
task_name=vit_base_ucf101_finetune_object_tracking_flow_small_v1 \
trainer=ddp_unused \
trainer.devices=1 \
trainer.num_nodes=1 \
...
configs.finetune_params.use_dit_decoder=True \
configs.finetune_params.flow_matching_loss=False \
