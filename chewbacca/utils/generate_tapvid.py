...
'''
python /home/tekotan/Chewbacca_test/chewbacca/utils/generate_tapvid.py \
  --input_csv_path=/home/tekotan/Chewbacca_test/data-download/tapvid_kinetics/tapvid_kinetics.csv \
  --output_base_path=. \
  --video_root_path=/home/tekotan/Chewbacca_test/data-download/kinetics/kinetics-dataset/k700-2020/val/ \
  --alsologtostderr
'''
import csv
import dataclasses
